 ...
 */
final class Version20250629032507 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TEMPORARY TABLE __temp__jobs AS SELECT id, quote_id, client_id, company_id, invoice_id, status, description, scheduled_date, created, updated FROM jobs
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE jobs
        SQL);
